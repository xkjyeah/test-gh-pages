...
/* harmony export (immutable) */ __webpack_exports__["auto"] = auto;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_showdown__ = __webpack_require__(28);
...
function mount(elementSelector, url) {
  const elem = elementSelector instanceof HTMLElement ? elementSelector : document.querySelector(elementSelector);
  ...
  // fetch and mount
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(finalUrl, { responseType: 'text' }).then(r => {
    const converter = new __WEBPACK_IMPORTED_MODULE_1_showdown__["Converter"]();
...
function convertGithubToRawgit(url) {
  ...
  if (matches) {
    console.warn('You are using a raw Github URL with faq-o-matic. ' + 'Please use a cdn.rawgit.com URL for best performance! ' + 'For more information visit https://rawgit.com/');
